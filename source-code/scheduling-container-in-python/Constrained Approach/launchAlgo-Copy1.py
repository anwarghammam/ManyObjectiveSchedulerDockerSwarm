...
def transform(instance):
    ...
    algorithm2 = RandomSearch(
        problem=problem,
        termination_criterion=StoppingByEvaluations(max_evaluations=max_evaluations)
    )


    algorithm3 = LocalSearch(
        problem=problem,
    ...
    algorithm2.run()
    front2 = get_non_dominated_solutions(algorithm2.get_result())


    algorithm3.run()
    front2 = get_non_dominated_solutions(algorithm3.get_result())
    ...
    print()
    print()
    print("the 1 candidate solution is :")
    print()
    ...
    for solution in front2:
        ...
        front_sol2.append(solution.objectives)
    best_sol=resultat.index(min(resultat))
    candidate=(front[best_sol])

    print()
    print()
    print("the 2 candidate solution is :")
    print()
